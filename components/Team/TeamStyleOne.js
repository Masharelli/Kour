            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-3 col-sm-6">
                        <div className="single-scientist-box">
                            <div className="image">
                                <img src="/img/scientist/scientist5.png" alt="image" />
                            </div>
                            <div className="content">
                                <h3>Alina Sophia</h3>
                                <span>Data Management</span>
                    ...
                    <div className="col-lg-3 col-sm-6">
                        <div className="single-scientist-box">
                            <div className="image">
                                <img src="/img/scientist/scientist6.png" alt="image" />
                            </div>
                            <div className="content">
                                <h3>Liam Oliver</h3>
                                <span>Data Scientist</span>
                    ...
                    <div className="col-lg-3 col-sm-6">
                        <div className="single-scientist-box">
                            <div className="image">
                                <img src="/img/scientist/scientist7.png" alt="image" />
                            </div>
                            <div className="content">
                                <h3>Emma Olivia</h3>
                                <span>Analytical Solutions</span>
                    ...
                    <div className="col-lg-3 col-sm-6">
                        <div className="single-scientist-box">
                            <div className="image">
                                <img src="/img/scientist/scientist8.png" alt="image" />
                            </div>
                            <div className="content">
