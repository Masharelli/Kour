                ...
                <div className="row">
                    <div className="col-lg-12 col-md-12">
                        <div className="case-studies-details-image">
                            <img src="/img/projects/industria-2.jpg" alt="image" />
                        </div>
                            ...
                            <div className="row align-items-center">
                                ...
                                <div className="col-lg-6 col-md-6">
                                    <div className="content">
                                        <ul>
                                            <li>Crea órdenes de fabricación, produce y vende tus artículos</li>
                                            <li>Devoluciones de piezas por defecto</li>
                                            <li>Genera anticipos a tus pedidos</li>
                                            <li>Fácil venta de kits de afinación</li>
                                            <li>Búsqueda de partes por modelo de vehículo</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
