                ...
                <div className="row">
                    <div className="col-lg-12 col-md-12">
                        <div className="case-studies-details-image">
                            <img src="/img/projects/industria-4.jpg" alt="image" />
                        </div>
                            ...
                            <div className="row align-items-center">
                                ...
                                <div className="col-lg-6 col-md-6">
                                    <div className="content">
                                        <ul>
                                        <li>Controla los artículos que manejan lotes o series</li>
                                        <li>Soportamos pedimentos aduanales</li>
                                        <li>Puedes cobrar y que la entrega la realice otra sucursal o tu CEDIS</li>
                                        <li> Maneja un concepto de apartado y entrega el producto cuando lo liquiden</li>
                                        <li>Controla las devoluciones por defecto</li>
