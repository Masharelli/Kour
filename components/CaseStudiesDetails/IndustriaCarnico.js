                ...
                <div className="row">
                    <div className="col-lg-12 col-md-12">
                        <div className="case-studies-details-image">
                            <img src="/img/projects/industria-3.jpg" alt="image" />
                        </div>
                            ...
                            <div className="row align-items-center">
                                ...
                                <div className="col-lg-6 col-md-6">
                                    <div className="content">
                                        <ul>
                                            <li>Maneja códigos de barra compuestos</li>
                                            <li>Vende por gramos, por kilo y/o por pieza</li>
                                            <li>Maneja precios por unidad de empaque</li>
                                            <li>Produce tus productos. Convierte el pollo en Nuggets</li>
                                            <li>Integración con básculas</li>
                                            <li>Realiza ajustes por merma</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
