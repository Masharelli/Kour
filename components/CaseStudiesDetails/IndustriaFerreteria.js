                ...
                <div className="row">
                    <div className="col-lg-12 col-md-12">
                        <div className="case-studies-details-image">
                            <img src="/img/projects/industria-5.jpg" alt="image" />
                        </div>
                            ...
                            <div className="row align-items-center">
                                ...
                                <div className="col-lg-6 col-md-6">
                                    <div className="content">
                                        <ul>
                                            <li>Maneja diferentes centros de costo</li>
                                            <li> Gestiona tus ventas por proyecto</li>
                                            <li>Maneja diferentes listas de precios dependiendo tu sucursal</li>
                                            <li>Maneja tus costos por almacén</li>
                                            <li>Haz tus compras en SAP y se distribuyen a tus sucursales</li>
                                            <li>Precios en moneda extranjera</li>
                                            <li> Usa un tipo de cambio al comprar y otro al vender</li>
                                            <li> Producción automática de artículos</li>
                                            <li> Generación de archivo para Truper</li>
                                            <li>Recepción de producto con dispositivo móvil</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
