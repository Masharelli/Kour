                ...
                <div className="row">
                    <div className="col-lg-12 col-md-12">
                        <div className="case-studies-details-image">
                            <img src="/img/projects/industria-9.jpg" alt="image" />
                        </div>
                            ...
                            <div className="row align-items-center">
                                ...
                                <div className="col-lg-6 col-md-6">
                                    <div className="content">
                                        <ul>
                                        <li>Crea canastas promocionales</li>
                                        <li>Genera descuentos sobre artículo de proveedores específicos</li>
                                        <li> Categoriza a tus clientes por medio de tipos de membresía</li>
                                        <li> Maneja tus productos en diferentes unidades de empaque</li>
                                        <li>Maneja tus precios en base a la unidad de empaque</li>
                                        <li>Maneja descuentos escalonados</li>
