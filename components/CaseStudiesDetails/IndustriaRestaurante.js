                ...
                <div className="row">
                    <div className="col-lg-12 col-md-12">
                        <div className="case-studies-details-image">
                            <img src="/img/projects/industria-1.jpg" alt="image" />
                        </div>
                        <div className="case-studies-details-desc">
                            ...
                            <div className="row align-items-center">
                                <div className="col-lg-6 col-md-6">
                                    <div className="image">
                                        <img src="/img/projects/projeect-re-2.jpg" alt="image" />
                                    </div>
                                </div>
                                ...
                                <div className="col-lg-6 col-md-6">
                                    <div className="content">
                                        <ul>
                                            <li> Administración de meseros</li>
                                            <li>Estados de mesa (Ocupada, reservada y disponible)</li>
                                            <li> Mapa de áreas de restaurante</li>
                                            <li> Platillos preparados sin cobrar</li>
                                            <li>División de cuentas por comensal o por monto</li>
                                            <li>Unión de mesas</li>
                                            <li>Traslado de cuentas</li>
                                            <li>Reapertura de cuentas</li>
                                            <li>Promociones (Por día de la semana y hora)</li>
                                            <li>Control de tiempos (Entrada, plato fuerte, postre, etc.)</li>
                                            <li>Manejo de propinas</li>
                                            <li>Venta a crédito</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
